...
public interface PolylineCancelLineHandler {
  ...
  /**
   * Encapsulates the arguments for the MapEvent.CANCELLINE event on a
   * {@link Polyline}.
   */
  @SuppressWarnings("serial")
  class PolylineCancelLineEvent extends EventObject {

    public PolylineCancelLineEvent(Polyline source) {
      super(source);
    }
  ...
  /**
   * Method to be invoked when a MapEvent.CANCELLINE event fires on a
   * {@link Polyline}.
   * 
   * @param event contains the properties of the event.
   */
  void onCancel(PolylineCancelLineEvent event);
}
