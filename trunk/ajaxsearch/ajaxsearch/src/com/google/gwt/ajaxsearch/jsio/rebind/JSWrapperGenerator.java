 ...
 * the License.
 */
package com.google.gwt.ajaxsearch.jsio.rebind;

import com.google.gwt.ajaxsearch.jsio.client.Constructor;
import com.google.gwt.ajaxsearch.jsio.client.Global;
import com.google.gwt.ajaxsearch.jsio.client.JSWrapper;
import com.google.gwt.ajaxsearch.jsio.client.NoIdentity;
import com.google.gwt.ajaxsearch.jsio.client.ReadOnly;
import com.google.gwt.ajaxsearch.jsio.client.impl.JSONWrapperUtil;
import com.google.gwt.ajaxsearch.jsio.client.impl.MetaDataName;
...
public class JSWrapperGenerator extends Generator {
  ...
  public final String generate(TreeLogger logger, GeneratorContext context,
    ...
    f.addImport("com.google.gwt.ajaxsearch.jsio.client.*");
    f.addImport("com.google.gwt.ajaxsearch.jsio.client.impl.*");
