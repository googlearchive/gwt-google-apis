...
import com.google.gwt.ajaxsearch.jsio.client.JSONWrapperException;
import com.google.gwt.ajaxsearch.jsio.client.JSWrapper;
...
public final class JSListWrapper<T> extends AbstractList<T> implements
  ...
  private static class WrappingExtractor<T> implements
    ...
    public native JSListWrapper<T> fromJS(JavaScriptObject obj) /*-{
      var toReturn = @com.google.gwt.ajaxsearch.jsio.client.impl.JSListWrapper::create(Lcom/google/gwt/ajaxsearch/jsio/client/impl/Extractor;)(
      this.@com.google.gwt.ajaxsearch.jsio.client.impl.JSListWrapper.WrappingExtractor::subExtractor);
      toReturn.@com.google.gwt.ajaxsearch.jsio.client.JSWrapper::setJavaScriptObject(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
      return toReturn;
    }-*/;

    public native JavaScriptObject toJS(JSListWrapper<T> o) /*-{
      return this.@com.google.gwt.ajaxsearch.jsio.client.JSWrapper::getJavaScriptObject()();
    }-*/;
  }
