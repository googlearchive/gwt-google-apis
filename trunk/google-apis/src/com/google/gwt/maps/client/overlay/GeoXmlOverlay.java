 ...
 * XML or KML file.
 * 
 * TODO: add functionality from API v2.84
 */
public final class GeoXmlOverlay extends ConcreteOverlay {
   ...
   * 
   * @param url the URL of the XML or KML file
   */
  public GeoXmlOverlay(String url) {
    super(OverlayImpl.impl.constructGeoXmlOverlay(url));
  }
