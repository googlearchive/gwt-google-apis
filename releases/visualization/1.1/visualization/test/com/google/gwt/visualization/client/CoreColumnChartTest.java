 ...
 */
public class CoreColumnChartTest extends VisualizationTest {
  /**
   * This test case will try creating a simple Column chart. It first asserts
   * that the Visualization API has been correctly loaded
   * (see ajax_loader.html)
   */
  public void testASimpleColumnChart() {
  ...
  public void testOnMouseOver() {
    loadApi(new Runnable() {
      public void run() {
        Options options = Options.create();
        ColumnChart chart = new ColumnChart(createCompanyPerformance(), options);
