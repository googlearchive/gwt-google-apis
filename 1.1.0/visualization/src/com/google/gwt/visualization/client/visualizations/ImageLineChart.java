 ...
 *      > Image Line Chart Visualization Reference</a>
 */
public class ImageLineChart extends Visualization<ImageLineChart.Options> {
  ...
  public static class Options extends CommonChartOptions {
     ...
     * axis labels). Default value is <code>true</code>, or value of
     * {@link ImageLineChart.Options#setShowAxisLines(boolean)} if set.
     */
