 ...
 */
public class CoreBarChartTest extends VisualizationTest {
  /**
   * This test case will try creating a simple Bar chart. It first asserts that
   * the Visualization API has been correctly loaded (see ajax_loader.html).
   */
  public void testASimpleBarChart() {
    loadApi(new Runnable() {
      public void run() {
        ...
        RootPanel.get().add(new BarChart(data, options));
      }
    });
  }
  ...
  public void testOnMouseOver() {
    loadApi(new Runnable() {
      public void run() {
        Options options = Options.create();
        BarChart chart = new BarChart(createCompanyPerformance(), options);
