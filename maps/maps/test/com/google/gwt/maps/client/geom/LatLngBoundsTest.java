...
public class LatLngBoundsTest extends GWTTestCase {
  ...
  public void testContainsLatLng() {
    ...
    assertTrue("contains 45,45", bounds.containsLatLng(LatLng.newInstance(45,
        45)));
    assertFalse("contains -45,0", bounds.containsLatLng(LatLng.newInstance(-45,
        0)));
  }
  ...
  public void testExtend() {
    ...
    assertTrue(
        "northeast expected: " + expected + " got: " + b1.getNorthEast(),
        expected.isEquals(b1.getNorthEast()));
  }
