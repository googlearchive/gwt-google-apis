...
class Task {
  ...
  protected String extractFieldName(TreeLogger logger, JMethod m,
    ...
    if (fieldNameAnnotation == null) {
      ...
      com.google.gwt.ajaxsearch.jsio.client.NamePolicy namePolicyAnnotation = JSWrapperGenerator.hasTag(
          logger, enclosing, com.google.gwt.ajaxsearch.jsio.client.NamePolicy.class);
      NamePolicy policy;
