...
function __MODULE_FUNC__() {
	...
	, $stats = $wnd.__gwtStatsEvent ? function(a) {
		return $wnd.__gwtStatsEvent(a);
	} : null; // end of global vars
	...
	function isHostedMode() {
		try {
			return (external && external.gwtOnLoad && ($wnd.location.search
					.indexOf('gwt.hybrid') == -1));
		} catch (e) {
	 ...
	 * single locale parameter. ($wnd.__gwt_Locale is read by the property
	 * provider in I18N.gwt.xml)
	 */
	function setLocale() {
	...
	if (isHostedMode()) {
		...
		var loadFrom = gadgets.io.getProxyUrl(fullName, {
			REFRESH_INTERVAL :31536000
		});
