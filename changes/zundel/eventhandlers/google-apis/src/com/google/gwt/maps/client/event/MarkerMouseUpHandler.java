...
/**
 * Provides an interface to implement in order to receive MapEvent.MOUSEUPevents from the
  * {@link Marker}.
 */
public interface MarkerMouseUpHandler {
  ...
  /**
   * Method to be invoked when a MapEvent.MOUSEUP event fires on a {@link Marker}.
   * 
   * @param event contains the properties of the event.
   */
  void onMouseUp(MarkerMouseUpEvent event);
}
