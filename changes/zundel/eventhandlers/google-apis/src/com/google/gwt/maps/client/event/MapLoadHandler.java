...
/**
 * Provides an interface to implement in order to receive MapEvent.LOADevents from the
  * {@link MapWidget}.
 */
public interface MapLoadHandler {
  ...
  /**
   * Method to be invoked when a MapEvent.LOAD event fires on a {@link MapWidget}.
   * 
   * @param event contains the properties of the event.
   */
  void onLoad(MapLoadEvent event);
}
