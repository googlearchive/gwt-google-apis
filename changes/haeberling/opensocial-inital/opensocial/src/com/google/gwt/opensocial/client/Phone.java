 ...
 * 
 * @see "http://code.google.com/apis/opensocial/docs/0.8/reference/#opensocial.Phone"
 */
public final class Phone extends JavaScriptObject {
  protected Phone() {
  }
   ...
   *
   * @param key The key to get data for; keys are defined in Phone.Field
   * @return The data
   */
