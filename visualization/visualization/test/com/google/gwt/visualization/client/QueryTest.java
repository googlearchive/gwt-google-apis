...
public class QueryTest extends VisualizationTest {
  ...
  public void testQuerySpreadsheetFail() {
    loadApi(new Runnable() {
      public void run() {
        // Set a longer timeout than the default in VisualizationTest. Sometimes a remote URL takes a
        // while to respond, and I want to make sure it is longer than the timeout
        // value set in query.setTimeout()
        delayTestFinish(10000);
        // Run with the URL for a bogus spreadsheet - should cause this call to fail.
        ...
        query.send(new Callback() {
          public void onResponse(QueryResponse response) {
            ...
            fail("Response expected an Error");
          }
        });
      }
    }, false);
