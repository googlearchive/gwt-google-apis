...
public interface PolylineRemoveHandler {
  ...
  class PolylineRemoveEvent extends EventObject {

    public PolylineRemoveEvent(Polyline source) {
      super(source);
    }
  ...
  /**
   * Method to be invoked when a MapEvent.REMOVE event fires on a
   * {@link Polyline}.
   * 
   * @param event contains the properties of the event.
   */
  void onRemove(PolylineRemoveEvent event);
}
